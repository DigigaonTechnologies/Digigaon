  ...
  return (
    <div className="relative w-full text-white">
      ...
      <div className="relative w-full bg-[#1c2430] clip-slant flex flex-col items-center justify-center px-4 sm:px-8 lg:px-16 pt-16 pb-6">
        ...
        {/* Footer Content */}
        <div className="flex flex-col lg:flex-row gap-10 lg:gap-[13vw] mt-25 md:mt-10 w-full lg:w-auto justify-center items-center lg:items-start">
          {/* About Company */}
          <motion.div
            ref={ref}
            initial={{ opacity: 0, y: 60 }} // start invisible + slightly below
            animate={inView ? { opacity: 0.5, opacity: 1, y: 0 } : {}}
            transition={{ duration: 0.4, ease: "easeOut" }}
            className="w-full sm:w-[70%] md:w-[50%] lg:w-[22vw] text-center lg:text-left"
          >
            ...
            <p className="text-[0.8rem] relative  leading-4 font-light mt-12 md:mt-3 text-gray-300">
              Digigaon Technologies LLP is a dynamic IT solutions and service
              provider dedicated to delivering innovative and reliable digital
              solutions. Established with the vision of bridging technology with
              everyday needs, we offer a diverse range of services tailored to
              businesses, individuals, and government sectors.
            </p>
          </motion.div>
          ...
          <motion.div
            ...
            className="w-full sm:w-[50%] md:w-[40%] lg:w-[15vw] text-center lg:text-left"
          >
            <h1 className="font-bold p-1 border-[#FF6900] border-b-2 w-max mx-auto lg:mx-0 text-base sm:text-lg lg:text-[1.5vw]">
              CONTACT
            </h1>
            <h1 className="mt-3 flex gap-2 ">
              <span className="bg-[#FF6900] p-1">
                <FaPhoneAlt />
              </span>
              <span className="hover:scale-110 transition-all hover:text-orange-400">
                +91 9131957450
              </span>{" "}
            </h1>
            <h1 className="mt-1.5 flex gap-2">
              <span className="bg-[#FF6900] p-1">
                <SiGmail />
              </span>{" "}
              <a
                className="hover:scale-110 transition-all hover:text-orange-400"
                href="mailto:digigaontechnologies@gmail.com"
              >
                digigaontechnologies@gmail.com
              </a>
            </h1>
            <h1 className="mt-1.5 w-max flex gap-2">
              <span className="bg-[#FF6900] p-1">
                <FaLocationDot />
              </span>{" "}
              <span className="hover:scale-110 transition-all hover:text-orange-400">
                Sausar , Madhyapradesh 480106, IN
              </span>
            </h1>
            {/* digigaontechnologies@gmail.com */}
          </motion.div>
        ...
        <p className="text-xs mt-10 text-center text-gray-400 px-4">
          © 2021 DigiGaon Technologies LLP. All rights reserved. | Privacy
