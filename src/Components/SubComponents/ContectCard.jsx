...
const ContectCard = ({ id, text1, text2, paths }) => {
  return (
    <div className=" relative bg-[#1c2430] text-white hover:scale-120 transition-transform duration-300 ease-in-out rounded-lg p-8 w-full text-center shadow-md">
      ...
      <p className="text-[3vw] md:text-[1.2vw] text-center  w-full">
        {id == 2 ? (
          <a
