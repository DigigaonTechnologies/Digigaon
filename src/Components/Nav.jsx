    ...
    <>
      ...
      <div className="nav fixed top-0 z-[999] w-[100vw] min-h-[15vh] bg-[#375f8836]  flex items-center backdrop-blur-lg  justify-between px-2 md:px-10">
        ...
        <div className="sec gap-4 text-xl font-semibold  hidden md:flex text-[#000000b8] ">
          <NavLink  className={hover ? "hover:text-[#FF6900] hover:scale-120 transition-all":""}
            to="/"
          ...
          <NavLink
            to="/services"
            className={hover ? "hover:text-[#FF6900] hover:scale-120 transition-all":""}
          >
            Services
          </NavLink>
           <NavLink
