      ...
      <section className="w-full bg-white flex  flex-col items-center py-16 px-5 md:px-16 overflow-hidden md:mb-[10vh] scroll-smooth">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-gray-600 mt-3 max-w-2xl mx-auto text-sm md:text-base">
            Digigaon Technologies LLP provides IT solutions, software
            development, government procurement support, and financial
            compliance services, helping businesses and organizations operate
            efficiently, digitally, and in full regulatory compliance.
          </p>
        </div>
