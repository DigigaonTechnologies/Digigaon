    ...
    <div className=" relative min-w-full min-h-[100vh] scroll-smooth bg-white text-center">
      ...
      <section className="flex flex-col items-center justify-center py-16 px-6">
        ...
        <div className="flex flex-col md:flex-row items-center gap-10 relative mb-[15vh]">
         ...
         <ContectCard key={1} id={1} text1={"Call us"} text2={"+91 9131957450"} paths={"M2.25 6.75c0 8.284 6.716 15 15 15h2.25a1.5 1.5 0 001.5-1.5V18a1.5 1.5 0 00-1.5-1.5h-2.25A11.25 11.25 0 016.75 6.75V4.5A1.5 1.5 0 005.25 3h-2.25A1.5 1.5 0 001.5 4.5v2.25z"} />
          </div>
