...
const Home = () => {
  ...
  return (
    <div className=" relative min-w-full min-h-[100vh] scroll-smooth bg-white text-center">
      ...
      <section>
        <div
          className="relative w-full min-h-[80vh] md:h-[140vh]  bg-cover bg-center py-20 flex flex-col items-center after:absolute after:top-0 after:left-0 after:w-full after:h-full after:bg-white after:opacity-30"
          style={{
      ...
      <section className="bg-white relative py-16 px-4 md:px-8 text-center flex-col items-center justify-center">
        <AnimatedText2>
          <h3
            className=" relative  text-3xl text-[#232121] md:text-[5vw]  mt-4 tracking-tight  font-bold mb-5"
            style={{
              lineHeight: "1",
              textShadow: "2px 2px 4px rgba(0, 0, 0, 0.5)",
            }}
      ...
      <section className=" relative bg-[#1F2732]   flex flex-col items-center justify-center overflow-x-hidden ">
        <AnimatedText2>
          <h3
            className=" relative mt-10 text-3xl text-[#ffffff] md:text-[5vw]  font-bold mb-5"
            style={{
              lineHeight: "1.2",
        ...
        <div className="absolute z-10 left-[34%]   md:top-[27%] top-[35%]  ">
          <img src={line1} className=" relative h-[16vw]" alt="" />
        </div>
        <div className="absolute z-10 left-[66%]  md:top-[48.5%] top-[55%] ">
          <img src={line2} className=" relative h-[16vw]" alt="" />
        </div>
        <div className="absolute z-10 left-[33%]  md:top-[70.3%] top-[75%] ">
          <img src={line1} className=" relative h-[16vw]" alt="" />
        </div>
        {data1.steps.map((step) => (
          <div
            key={step.id}
            className={`w-full relative  bg-[#1F2732]  h-[17vh] md:h-max flex  items-center ${
      ...
      <section className="flex flex-col items-center justify-center mt-16 px-6">
        {/* Title */}
        <AnimatedText2>
          <h3
            className=" relative   text-3xl text-[#232121] md:text-[5vw]  tracking-tight leading-[1em] font-bold mb-[15vh] cursor-pointer"
            style={{
              lineHeight: "1",
              textShadow: "2px 2px 4px rgba(0, 0, 0, 0.5)",
            }}
        ...
        <div className="flex flex-col md:flex-row items-center gap-10 relative mb-[15vh]">
          ...
          <div className="w-56 md:w-72">
            <ContectCard
              ...
              text2={"+91 9131957450"}
              paths={
                "M2.25 6.75c0 8.284 6.716 15 15 15h2.25a1.5 1.5 0 001.5-1.5V18a1.5 1.5 0 00-1.5-1.5h-2.25A11.25 11.25 0 016.75 6.75V4.5A1.5 1.5 0 005.25 3h-2.25A1.5 1.5 0 001.5 4.5v2.25z"
              }
            />
          </div>
          ...
          <div className="w-56 md:w-72">
            <ContectCard
              ...
              paths={
                "M16.862 4.487l1.687-1.688a2.25 2.25 0 113.182 3.182L10.5 17.213 6.75 18l.787-3.75L16.862 4.487z"
              }
            />
          </div>
        </div>
